...
export default function AdminAuditLogsClient({ logs }: { logs: AuditLog[] }) {
  ...
  const securityEvents = logs.filter((l) => l.resourceType === 'auth' || l.resourceType === 'security').length;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900 dark:text-white">{securityEvents}</p>
                </div>
          ...
          <Card>
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-1">Resource Types</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white">{resourceTypes.length - 1}</p>
                </div>
