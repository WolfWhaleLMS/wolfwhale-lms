...
export default function ParentChildrenPage() {
  ...
  const totalMissing = mockChildren.reduce((sum, c) => sum + c.missingWork, 0);
  const avgGPA =
    mockChildren.reduce((sum, c) => sum + c.gpa, 0) / mockChildren.length;
  const avgAttendance =
    mockChildren.reduce((sum, c) => sum + c.attendanceRate, 0) /
    mockChildren.length;
