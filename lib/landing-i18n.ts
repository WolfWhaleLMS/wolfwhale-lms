...
export const landingContent: Record<Lang, LandingContent> = {
  en: {
    ...
    volumeDiscounts: 'Volume discounts for school boards.',
    aboutTitle: 'Why WolfWhale',
    aboutText: 'We build the most powerful native iOS LMS. 106+ features across 122K lines of Swift. Deeply integrated with 30 Apple frameworks. We serve K-12, post-secondary, and training organizations. Canadian values drive everything we ship — privacy, accessibility, bilingual support.',
    canadaTitle: 'Built in Canada',
    canadaSub: 'Vancouver, BC. Designed, developed, hosted here.',
    canadaBadges: [
