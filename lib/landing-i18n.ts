...
export const landingContent: Record<Lang, LandingContent> = {
  en: {
    ...
    features: [
      ...
      { icon: Bot, title: 'On-Device AI (6 Tools)', slug: 'ai-tools', points: ['AI Tutor with curriculum awareness', 'Micro-Lesson Converter (industry first)', 'Lesson Plan Builder', 'Report Card Comments', 'AI Search across all content', 'Apple Intelligence \u2014 data never leaves device'], color: '#0891B2' },
      { icon: BookOpen, title: '72 Original Textbooks', slug: 'textbooks', points: ['288+ chapters with interactive content', 'Full SK K-12 curriculum coverage', 'WolfWhale Books publisher brand', 'Flashcards, quizzes & activities built in'], color: '#D97706' },
      ...
      { icon: Gamepad2, title: 'Gamification & XP', slug: 'gamification', points: ['XP system with streaks & leaderboards', 'Study Pet companion (fish collection)', 'Chess, Kahoot, spelling bee & more', 'Common to Legendary badge rarity'], color: '#D97706' },
      { icon: Eye, title: 'Apple Liquid Glass UI', slug: 'liquid-glass', points: ['Built with Apple\'s latest Liquid Glass SDK', 'Stunning, native iOS design language', 'Translucent materials and depth effects', 'Students actually want to use it'], color: '#0891B2' },
    ...
    packages: [
      {
        ...
        features: [
          ...
          '72 original textbooks & 288 chapters',
          'AI teaching tools (on-device)',
          'Gradebook, attendance & report cards',
          'Onboarding & training',
          'Priority support',
        ],
        cta: 'Request a Quote',
    ...
    customNote: 'Every account gets full access to all features — no feature gating, no tiers. The same platform for students, teachers, parents, and administrators. Custom pricing based on your school or division size.',
  ...
  fr: {
    ...
    features: [
      ...
      { icon: Bot, title: 'IA sur l\u2019appareil (6 outils)', slug: 'ai-tools', points: ['Tuteur IA avec contexte du programme', 'Convertisseur de micro-le\u00e7ons (premi\u00e8re mondiale)', 'G\u00e9n\u00e9rateur de plans de cours', 'Commentaires de bulletins', 'Recherche IA dans tout le contenu', 'Apple Intelligence \u2014 donn\u00e9es sur l\u2019appareil'], color: '#0891B2' },
      { icon: BookOpen, title: '72 manuels originaux', slug: 'textbooks', points: ['288+ chapitres avec contenu interactif', 'Couverture compl\u00e8te du programme SK K-12', 'Marque \u00e9ditoriale WolfWhale Books', 'Cartes m\u00e9moire, quiz et activit\u00e9s int\u00e9gr\u00e9s'], color: '#D97706' },
      ...
      { icon: Gamepad2, title: 'Ludification et XP', slug: 'gamification', points: ['Syst\u00e8me XP avec s\u00e9ries et classements', 'Compagnon d\u2019\u00e9tude (collection de poissons)', '\u00c9checs, Kahoot, quiz orthographe et plus', 'Badges de Commun \u00e0 L\u00e9gendaire'], color: '#D97706' },
      { icon: Eye, title: 'Apple Liquid Glass UI', slug: 'liquid-glass', points: ['Con\u00e7u avec le dernier SDK Liquid Glass d\u2019Apple', 'Design iOS natif \u00e9poustouflant', 'Mat\u00e9riaux translucides et effets de profondeur', 'Les \u00e9l\u00e8ves veulent vraiment l\u2019utiliser'], color: '#0891B2' },
    ...
    packages: [
      {
        ...
        features: [
          ...
          '72 manuels originaux et 288 chapitres',
          'Outils IA (sur l\'appareil)',
          'Carnet de notes, présences et bulletins',
      ...
      },
      {
        ...
        features: [
          ...
          'Outils IA (sur l\'appareil)',
          'Carnet de notes, présences et bulletins',
          'Déploiement MDM en masse et SSO',
