...
- `npm test`: passed, 30 files / 128 tests after the direct admin invite slice.
- `npm run lint`: passed after the direct admin invite slice.
- `npm run typecheck`: passed after the direct admin invite slice.
- `npm run build`: passed after the direct admin invite slice; route list includes `/api/lms/courses`, `/api/lms/invitations`, `/api/lms/messages`, and `/student/companion-world`.
