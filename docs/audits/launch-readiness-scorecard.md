...
- `npm test`: passed, 32 files / 135 tests after the grade-trend reporting slice.
- `npm run lint`: passed after the grade-trend reporting slice.
- `npm run typecheck`: passed after the grade-trend reporting slice.
- `npm run build`: passed after the grade-trend reporting slice; route list includes `/api/lms/calendar-events`, `/api/lms/courses`, `/api/lms/guardian-links`, `/api/lms/invitations`, `/api/lms/messages`, and `/student/companion-world`.
- `npm run load:smoke`: passed after the grade-trend reporting slice in 2529ms for 5000 students, 500 teachers, 1000 courses, and 50000 enrollments.
