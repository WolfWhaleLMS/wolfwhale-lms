...
- `npm test`: passed, 32 files / 136 tests after the student/guardian submitted-file affordance slice.
- `npm run lint`: passed after the student/guardian submitted-file affordance slice.
- `npm run typecheck`: passed after the student/guardian submitted-file affordance slice.
- `npm run build`: passed after the student/guardian submitted-file affordance slice; route list includes `/api/lms/calendar-events`, `/api/lms/courses`, `/api/lms/guardian-links`, `/api/lms/invitations`, `/api/lms/messages`, `/api/lms/submissions/[submissionId]/file`, and `/student/companion-world`.
- `npm run load:smoke`: passed after the student/guardian submitted-file affordance slice in 2420ms for 5000 students, 500 teachers, 1000 courses, and 50000 enrollments.
