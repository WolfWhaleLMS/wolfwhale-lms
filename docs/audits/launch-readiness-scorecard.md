...
- `npm test`: passed, 35 files / 154 tests after the attendance XP slice.
- `npm run lint`, `npm run typecheck`, `npm run build`, `npm audit --audit-level=moderate`, and `git diff --check`: passed after the attendance XP slice.
...
- `npm test -- tests/fish-companion.test.ts`: passed, 12 tests covering fish-only starter species, fish sprite metadata, fish companion storage keys, legacy non-fish language exclusion, and the fish-only Supabase species migration.
...
- `npm run build`: passed after the attendance XP slice; route list includes `/api/lms/calendar-events`, `/api/lms/courses`, `/api/lms/exports/messages`, `/api/lms/guardian-links`, `/api/lms/guardian-links/contact`, `/api/lms/guardian-links/unlink`, `/api/lms/invitations`, `/api/lms/invitations/resend`, `/api/lms/memberships/role`, `/api/lms/memberships/status`, `/api/lms/messages`, `/api/lms/messages/[messageId]/moderation`, `/api/lms/submissions/[submissionId]/file`, and `/student/companion-world`.
