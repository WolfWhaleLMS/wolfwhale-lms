...
- `npm test`: passed, 32 files / 142 tests after the audited guardian-contact slice.
- `npm run lint`: passed after the audited guardian-contact slice.
- `npm run typecheck`: passed after the audited guardian-contact slice.
- `npm run build`: passed after the audited guardian-contact slice; route list includes `/api/lms/calendar-events`, `/api/lms/courses`, `/api/lms/guardian-links`, `/api/lms/guardian-links/contact`, `/api/lms/guardian-links/unlink`, `/api/lms/invitations`, `/api/lms/invitations/resend`, `/api/lms/memberships/role`, `/api/lms/memberships/status`, `/api/lms/messages`, `/api/lms/submissions/[submissionId]/file`, and `/student/companion-world`.
