...
- `npm test`: passed, 32 files / 137 tests after the audited guardian-unlink slice.
- `npm run lint`: passed after the audited guardian-unlink slice.
- `npm run typecheck`: passed after the audited guardian-unlink slice.
- `npm run build`: passed after the audited guardian-unlink slice; route list includes `/api/lms/calendar-events`, `/api/lms/courses`, `/api/lms/guardian-links`, `/api/lms/guardian-links/unlink`, `/api/lms/invitations`, `/api/lms/messages`, `/api/lms/submissions/[submissionId]/file`, and `/student/companion-world`.
- `npm run load:smoke`: passed after the audited guardian-unlink slice in 2418ms for 5000 students, 500 teachers, 1000 courses, and 50000 enrollments.
