...
| 11. Messaging works between allowed roles | `app/api/lms/messages/route.ts`, `app/api/lms/exports/messages/route.ts`, `lib/lms/mutations.ts`, `lib/lms/exports.ts`, `components/lms/SharedLmsPanels.tsx`, `components/lms/AdminDashboard.tsx`, `components/lms/TeacherDashboard.tsx`, `components/lms/student-workspaces/calendar-resources-messages.tsx`, `supabase/migrations/20260510233000_course_message_write_policy.sql`, `tests/lms-messages.test.ts`, `tests/lms-message-export.test.tsx` | Partial: audited write workflow, relationship-aware policy artifact, and staff message CSV export exist; moderation, retention policy controls, and live RLS validation remain pending |
