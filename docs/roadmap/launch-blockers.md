...
- Admin lifecycle for invite resend, role changes, primary-contact/consent details, and audit review. Direct audited single-user invite creation, membership deactivate/reactivate, and guardian linking/unlinking now exist.
