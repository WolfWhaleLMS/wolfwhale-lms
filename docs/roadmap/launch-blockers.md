...
- Admin lifecycle for invite resend, primary-contact/consent details, and audit review. Direct audited single-user invite creation, membership deactivate/reactivate, role changes, and guardian linking/unlinking now exist.
