...
- Admin user lifecycle: resend invites, reset roles, primary-contact/consent details, and audit review. Initial direct invites, membership deactivate/reactivate, and guardian linking/unlinking now exist.
