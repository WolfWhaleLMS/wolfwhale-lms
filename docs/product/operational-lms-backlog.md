...
- Admin user lifecycle: resend invites, primary-contact/consent details, and audit review. Initial direct invites, membership deactivate/reactivate, role changes, and guardian linking/unlinking now exist.
