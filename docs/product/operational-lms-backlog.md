...
- Admin user lifecycle: primary-contact/consent details and audit review. Initial direct invites, invite resend, membership deactivate/reactivate, role changes, and guardian linking/unlinking now exist.
