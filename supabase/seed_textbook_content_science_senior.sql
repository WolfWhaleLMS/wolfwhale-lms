...
BEGIN
  ...
  VALUES (v_tenant, v_book, v_unit, v_ch_num, 'Water & Climate', 'water-and-climate',
    ...
    '[
      ...
      {"type": "callout", "content": "Saskatchewan''s prairie potholes, thousands of shallow wetlands left by retreating glaciers at the end of the last major glacial period, are sometimes called the duck factory of North America. They provide nesting habitat for an estimated 50–80% of North American ducks in good water years.", "style": "example"},
    ...
    '[
      ...
      {"term": "Prairie Pothole", "definition": "A shallow prairie wetland formed by glacial activity at the end of the last major glacial period; critical habitat for migratory birds."}
    ]'::jsonb,
