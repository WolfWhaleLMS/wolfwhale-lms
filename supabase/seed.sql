-- ============================================================================
-- Wolf Whale Learning Management System - Comprehensive Seed Data
-- Demo School: Wolf Whale Learning Management System (K-5 Elementary)
-- ============================================================================
--
...
VALUES (
  ...
  '(310) 555-0100',
  'Principal of Wolf Whale Learning Management System with 20 years of experience in elementary education. Ed.D. in Educational Leadership from UCLA.',
  'America/Los_Angeles'
);
...
FROM tenants t, (VALUES
  ...
  ('a0000000-0000-0000-0000-000000000001'::uuid, 'system_alert', 'Weekly Usage Report',
   'Wolf Whale Learning Management System: 15 active students, 3 active teachers, 6 active courses this week.',
   '/admin/reports',
   NULL, NULL,
...
-- ============================================================================
-- END OF SEED DATA
-- Wolf Whale Learning Management System - K-5 Elementary
