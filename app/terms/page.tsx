    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '0s', animationDuration: '6s' }}
        />
        <div
          className="absolute top-40 right-[15%] w-2 h-2 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '1s', animationDuration: '8s' }}
        />
        <div
          className="absolute top-[30%] left-[5%] w-4 h-4 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '2s', animationDuration: '7s' }}
        />
        <div
          className="absolute top-[50%] right-[8%] w-2.5 h-2.5 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '3s', animationDuration: '9s' }}
        />
        <div
          className="absolute top-[70%] left-[20%] w-3.5 h-3.5 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '4s', animationDuration: '6.5s' }}
        />
        <div
          className="absolute top-[15%] right-[30%] w-2 h-2 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '1.5s', animationDuration: '7.5s' }}
        />
        <div
          className="absolute top-[60%] left-[40%] w-3 h-3 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '2.5s', animationDuration: '8.5s' }}
        />
        <div
          className="absolute top-[85%] right-[25%] w-2 h-2 rounded-full animate-float"
          style={{ backgroundColor: 'rgba(26,42,78,0.12)', animationDelay: '0.5s', animationDuration: '7s' }}
        />
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-[#1a2a4e]/50">Learning Management System</p>
            </div>
          </Link>
