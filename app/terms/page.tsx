...
These Terms apply to all users of the platform, including students, teachers, school administrators, and parents or guardians accessing the Parent Portal.`,
      },
      {
        ...
        body: `WolfWhale LMS is a Canadian K\u201312 learning management system designed to support the full educational experience. Our platform provides the following services:
...
User accounts on WolfWhale LMS are created by authorized school administrators. Individual users do not self-register. Each account is associated with a specific educational institution and assigned a role (student, teacher, administrator, or parent).
...
WolfWhale reserves the right to suspend or terminate user accounts that violate these Terms, engage in prohibited conduct, or pose a security risk to the platform. School administrators may also request the suspension or deactivation of accounts within their institution.`,
      },
      {
        id: 'acceptable-use-policy',
        heading: '4. Acceptable Use Policy',
        body: `WolfWhale LMS is intended exclusively for educational purposes. All users must use the platform in a manner that is respectful, lawful, and consistent with the educational mission of their institution.
...
**Enforcement**
Violations of this Acceptable Use Policy may result in warnings, content removal, temporary suspension, or permanent termination of access, at the discretion of WolfWhale and/or the school administration.`,
      },
      {
        id: 'intellectual-property',
        heading: '5. Intellectual Property',
        body: `**WolfWhale Property**
WolfWhale LMS, including its design, source code, user interface, branding, logos, documentation, and all related intellectual property, is the exclusive property of WolfWhale Inc. All rights are reserved. No part of the platform may be copied, reproduced, distributed, or used without the express written consent of WolfWhale Inc.
...
**Teacher Content**
Teachers retain all intellectual property rights to their course materials, lesson plans, assessments, and other educational content created on or uploaded to the platform. WolfWhale does not claim ownership of teacher-created content.

**License Grant**
By uploading or creating content on WolfWhale LMS, you grant WolfWhale a limited, non-exclusive license to host, store, display, and transmit that content solely for the purpose of providing the educational services described in these Terms. This license terminates when the content is deleted or the account is closed.`,
      },
      {
        id: 'payment-terms',
        heading: '6. Payment Terms',
        body: `**Pricing**
WolfWhale LMS is offered at a rate of **$12 CAD per user account per month**. This pricing includes full access to all platform features with no additional fees for modules or add-ons.
...
**Price Changes**
WolfWhale reserves the right to adjust pricing with a minimum of **90 days' written notice** to the contracting school or district. Price changes take effect at the start of the next contract renewal period and do not apply retroactively to the current term.
...
Fees are generally non-refundable once paid. In the event of early termination by the school (see Section 11), any unused portion of pre-paid fees will be handled in accordance with the termination provisions of the service agreement.`,
      },
      {
        ...
        body: `WolfWhale is committed to protecting the personal information of all users, particularly students. Our data practices are governed by Canadian privacy law.

**Legal Compliance**
WolfWhale complies with the Personal Information Protection and Electronic Documents Act (PIPEDA) and all applicable provincial privacy legislation, including Quebec's Law 25, British Columbia's FIPPA, Alberta's FOIP Act, and Ontario's MFIPPA.
...
**Data Ownership**
Educational data belongs to the students and their institutions. WolfWhale acts as a data processor on behalf of the school.`,
      },
      {
        id: 'service-availability',
        heading: '8. Service Availability',
        body: `**Uptime Commitment**
WolfWhale strives to maintain **99.9% platform uptime** across all services. We invest in reliable infrastructure, redundancy, and monitoring to deliver a consistent experience for schools.
...
**Limitation**
WolfWhale is not liable for service interruptions caused by circumstances beyond our reasonable control, including but not limited to natural disasters, internet outages, third-party service failures, government actions, or cyberattacks. We will, however, take all reasonable steps to restore service promptly.`,
      },
      {
        id: 'disclaimers',
        heading: '9. Disclaimers',
        body: `**"As Is" Provision**
WolfWhale LMS is provided on an "as is" and "as available" basis. While we strive to deliver a reliable, high-quality platform, we make no warranties or representations, express or implied, regarding the platform's fitness for a particular purpose, merchantability, or uninterrupted availability.

**Educational Outcomes**
WolfWhale is a tool to support teaching and learning. We do **not** guarantee specific educational outcomes, test scores, grades, or academic results. The effectiveness of the platform depends on how it is used by educators, students, and institutions.

**User-Generated Content**
WolfWhale is not responsible for the accuracy, legality, or appropriateness of content created or uploaded by users. Schools and users are responsible for the content they publish on the platform. WolfWhale reserves the right to remove content that violates these Terms or applicable law.

**Third-Party Integrations**
Where the platform integrates with or links to third-party services, WolfWhale is not responsible for the availability, accuracy, or practices of those third-party services.`,
      },
      {
        id: 'limitation-of-liability',
        heading: '10. Limitation of Liability',
        body: `**Maximum Liability**
To the fullest extent permitted by applicable law, WolfWhale's total aggregate liability to you or your institution arising out of or related to these Terms or the use of the platform shall not exceed the total fees paid by your institution to WolfWhale in the **12 months immediately preceding** the event giving rise to the claim.

**Exclusion of Damages**
WolfWhale shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:
...
\u2022 All school data will be permanently deleted from WolfWhale's systems within **60 days** of the termination effective date, unless the school requests an earlier or later deletion
...
**Dispute Resolution**
Any dispute arising out of or relating to these Terms or the use of WolfWhale LMS shall be resolved as follows:
...
WolfWhale reserves the right to modify, update, or replace these Terms of Service at any time. Changes may be made to reflect new features, legal requirements, or business practices.
...
\u2022 A prominent notice within the WolfWhale LMS platform
\u2022 Updated publication on our website with a revised "Last updated" date

**Acceptance of Changes**
Continued use of WolfWhale LMS after the effective date of modified Terms constitutes acceptance of the revised Terms. If a school or user does not agree with the changes, they should discontinue use of the platform and contact us to discuss their concerns or initiate termination under Section 11.
...
Ces Conditions s\u2019appliquent \u00e0 tous les utilisateurs de la plateforme, y compris les \u00e9l\u00e8ves, les enseignants, les administrateurs scolaires et les parents ou tuteurs acc\u00e9dant au Portail des parents.`,
      },
      {
        ...
        body: `WolfWhale LMS est un syst\u00e8me de gestion de l\u2019apprentissage canadien con\u00e7u pour les \u00e9coles de la maternelle \u00e0 la 12e ann\u00e9e, destin\u00e9 \u00e0 soutenir l\u2019exp\u00e9rience \u00e9ducative compl\u00e8te. Notre plateforme offre les services suivants\u00a0:
...
Les comptes d\u2019utilisateurs sur WolfWhale LMS sont cr\u00e9\u00e9s par les administrateurs scolaires autoris\u00e9s. Les utilisateurs ne s\u2019inscrivent pas eux-m\u00eames. Chaque compte est associ\u00e9 \u00e0 un \u00e9tablissement d\u2019enseignement sp\u00e9cifique et se voit attribuer un r\u00f4le (\u00e9l\u00e8ve, enseignant, administrateur ou parent).
...
WolfWhale se r\u00e9serve le droit de suspendre ou de r\u00e9silier les comptes d\u2019utilisateurs qui enfreignent les pr\u00e9sentes Conditions, adoptent un comportement interdit ou repr\u00e9sentent un risque pour la s\u00e9curit\u00e9 de la plateforme. Les administrateurs scolaires peuvent \u00e9galement demander la suspension ou la d\u00e9sactivation de comptes au sein de leur \u00e9tablissement.`,
      },
      {
        id: 'acceptable-use-policy',
        heading: '4. Politique d\u2019utilisation acceptable',
        body: `WolfWhale LMS est destin\u00e9 exclusivement \u00e0 des fins \u00e9ducatives. Tous les utilisateurs doivent utiliser la plateforme de mani\u00e8re respectueuse, l\u00e9gale et conforme \u00e0 la mission \u00e9ducative de leur \u00e9tablissement.
...
**Application**
Les violations de la pr\u00e9sente Politique d\u2019utilisation acceptable peuvent entra\u00eener des avertissements, la suppression de contenu, la suspension temporaire ou la r\u00e9siliation permanente de l\u2019acc\u00e8s, \u00e0 la discr\u00e9tion de WolfWhale et/ou de l\u2019administration scolaire.`,
      },
      {
        id: 'intellectual-property',
        heading: '5. Propri\u00e9t\u00e9 intellectuelle',
        body: `**Propri\u00e9t\u00e9 de WolfWhale**
WolfWhale LMS, y compris sa conception, son code source, son interface utilisateur, son image de marque, ses logos, sa documentation et toute la propri\u00e9t\u00e9 intellectuelle connexe, est la propri\u00e9t\u00e9 exclusive de WolfWhale Inc. Tous droits r\u00e9serv\u00e9s. Aucune partie de la plateforme ne peut \u00eatre copi\u00e9e, reproduite, distribu\u00e9e ou utilis\u00e9e sans le consentement \u00e9crit expr\u00e8s de WolfWhale Inc.
...
Les enseignants conservent tous les droits de propri\u00e9t\u00e9 intellectuelle sur leur mat\u00e9riel p\u00e9dagogique, leurs plans de cours, leurs \u00e9valuations et tout autre contenu \u00e9ducatif cr\u00e9\u00e9 ou t\u00e9l\u00e9vers\u00e9 sur la plateforme. WolfWhale ne revendique aucun droit de propri\u00e9t\u00e9 sur le contenu cr\u00e9\u00e9 par les enseignants.

**Octroi de licence**
En t\u00e9l\u00e9versant ou en cr\u00e9ant du contenu sur WolfWhale LMS, vous accordez \u00e0 WolfWhale une licence limit\u00e9e et non exclusive pour h\u00e9berger, stocker, afficher et transmettre ce contenu uniquement dans le but de fournir les services \u00e9ducatifs d\u00e9crits dans les pr\u00e9sentes Conditions. Cette licence prend fin lorsque le contenu est supprim\u00e9 ou que le compte est ferm\u00e9.`,
      },
      {
        id: 'payment-terms',
        heading: '6. Conditions de paiement',
        body: `**Tarification**
WolfWhale LMS est offert au tarif de **7\u00a0$ CAD par compte d\u2019utilisateur par ann\u00e9e**. Ce tarif comprend l\u2019acc\u00e8s complet \u00e0 toutes les fonctionnalit\u00e9s de la plateforme sans frais suppl\u00e9mentaires pour des modules ou des options compl\u00e9mentaires.
...
Les frais sont g\u00e9n\u00e9ralement non remboursables une fois pay\u00e9s. En cas de r\u00e9siliation anticip\u00e9e par l\u2019\u00e9cole (voir la section\u00a011), toute portion inutilis\u00e9e des frais pr\u00e9pay\u00e9s sera trait\u00e9e conform\u00e9ment aux dispositions de r\u00e9siliation de l\u2019entente de service.`,
      },
      {
        ...
        body: `WolfWhale s\u2019engage \u00e0 prot\u00e9ger les renseignements personnels de tous les utilisateurs, en particulier ceux des \u00e9l\u00e8ves. Nos pratiques en mati\u00e8re de donn\u00e9es sont r\u00e9gies par les lois canadiennes sur la protection de la vie priv\u00e9e.

**Conformit\u00e9 l\u00e9gale**
WolfWhale se conforme \u00e0 la Loi sur la protection des renseignements personnels et les documents \u00e9lectroniques (LPRPDE) et \u00e0 toutes les lois provinciales applicables en mati\u00e8re de protection de la vie priv\u00e9e, y compris la Loi\u00a025 du Qu\u00e9bec, la FIPPA de la Colombie-Britannique, la FOIP Act de l\u2019Alberta et la LAIMPVP de l\u2019Ontario.
...
Les donn\u00e9es \u00e9ducatives appartiennent aux \u00e9l\u00e8ves et \u00e0 leurs \u00e9tablissements. WolfWhale agit en tant que sous-traitant des donn\u00e9es pour le compte de l\u2019\u00e9cole.`,
      },
      {
        id: 'service-availability',
        heading: '8. Disponibilit\u00e9 du service',
        body: `**Engagement de disponibilit\u00e9**
WolfWhale s\u2019efforce de maintenir une disponibilit\u00e9 de la plateforme de **99,9\u00a0%** pour l\u2019ensemble des services. Nous investissons dans une infrastructure fiable, la redondance et la surveillance pour offrir une exp\u00e9rience constante aux \u00e9coles.
...
**Limitation**
WolfWhale n\u2019est pas responsable des interruptions de service caus\u00e9es par des circonstances ind\u00e9pendantes de notre volont\u00e9, y compris, mais sans s\u2019y limiter, les catastrophes naturelles, les pannes d\u2019Internet, les d\u00e9faillances de services tiers, les mesures gouvernementales ou les cyberattaques. Nous prendrons toutefois toutes les mesures raisonnables pour r\u00e9tablir le service rapidement.`,
      },
      {
        id: 'disclaimers',
        heading: '9. Avis de non-responsabilit\u00e9',
        body: `**Fourniture \u00ab\u00a0telle quelle\u00a0\u00bb**
WolfWhale LMS est fourni sur une base \u00ab\u00a0telle quelle\u00a0\u00bb et \u00ab\u00a0selon la disponibilit\u00e9\u00a0\u00bb. Bien que nous nous efforcions de fournir une plateforme fiable et de haute qualit\u00e9, nous ne faisons aucune d\u00e9claration ni garantie, expresse ou implicite, concernant l\u2019ad\u00e9quation de la plateforme \u00e0 un usage particulier, sa qualit\u00e9 marchande ou sa disponibilit\u00e9 ininterrompue.

**R\u00e9sultats scolaires**
WolfWhale est un outil de soutien \u00e0 l\u2019enseignement et \u00e0 l\u2019apprentissage. Nous ne garantissons **pas** de r\u00e9sultats scolaires sp\u00e9cifiques, de notes d\u2019examen, de r\u00e9sultats acad\u00e9miques ou de r\u00e9alisations particuli\u00e8res. L\u2019efficacit\u00e9 de la plateforme d\u00e9pend de la mani\u00e8re dont elle est utilis\u00e9e par les \u00e9ducateurs, les \u00e9l\u00e8ves et les \u00e9tablissements.

**Contenu g\u00e9n\u00e9r\u00e9 par les utilisateurs**
WolfWhale n\u2019est pas responsable de l\u2019exactitude, de la l\u00e9galit\u00e9 ou du caract\u00e8re appropri\u00e9 du contenu cr\u00e9\u00e9 ou t\u00e9l\u00e9vers\u00e9 par les utilisateurs. Les \u00e9coles et les utilisateurs sont responsables du contenu qu\u2019ils publient sur la plateforme. WolfWhale se r\u00e9serve le droit de retirer tout contenu qui enfreint les pr\u00e9sentes Conditions ou la loi applicable.

**Int\u00e9grations tierces**
Lorsque la plateforme s\u2019int\u00e8gre \u00e0 des services tiers ou y renvoie, WolfWhale n\u2019est pas responsable de la disponibilit\u00e9, de l\u2019exactitude ou des pratiques de ces services tiers.`,
      },
      {
        id: 'limitation-of-liability',
        heading: '10. Limitation de responsabilit\u00e9',
        body: `**Responsabilit\u00e9 maximale**
Dans toute la mesure permise par la loi applicable, la responsabilit\u00e9 totale cumul\u00e9e de WolfWhale envers vous ou votre \u00e9tablissement, d\u00e9coulant de ces Conditions ou de l\u2019utilisation de la plateforme, ne saurait exc\u00e9der le montant total des frais pay\u00e9s par votre \u00e9tablissement \u00e0 WolfWhale au cours des **12 mois pr\u00e9c\u00e9dant imm\u00e9diatement** l\u2019\u00e9v\u00e9nement donnant lieu \u00e0 la r\u00e9clamation.

**Exclusion de dommages**
WolfWhale ne sera pas responsable des dommages indirects, accessoires, sp\u00e9ciaux, cons\u00e9cutifs ou punitifs, y compris, mais sans s\u2019y limiter\u00a0:
...
\u2022 Toutes les donn\u00e9es scolaires seront d\u00e9finitivement supprim\u00e9es des syst\u00e8mes de WolfWhale dans un d\u00e9lai de **60 jours** suivant la date d\u2019effet de la r\u00e9siliation, \u00e0 moins que l\u2019\u00e9cole ne demande une suppression anticip\u00e9e ou ult\u00e9rieure
...
Tout diff\u00e9rend d\u00e9coulant des pr\u00e9sentes Conditions ou de l\u2019utilisation de WolfWhale LMS sera r\u00e9solu comme suit\u00a0:
...
WolfWhale se r\u00e9serve le droit de modifier, de mettre \u00e0 jour ou de remplacer les pr\u00e9sentes Conditions d\u2019utilisation \u00e0 tout moment. Les modifications peuvent \u00eatre apport\u00e9es pour refl\u00e9ter de nouvelles fonctionnalit\u00e9s, des exigences l\u00e9gales ou des pratiques commerciales.
...
\u2022 Un avis visible sur la plateforme WolfWhale LMS
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <Image
              ...
              height={48}
              sizes="48px"
              className="rounded-xl object-contain border-2 border-black dark:border-white/10"
            />
            <div>
