...
export default function InfoPage() {
  return (
    <div className="min-h-screen text-white">
      ...
      <header className="relative z-10 border-b border-white/10 backdrop-blur-md bg-black/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <a
            ...
            className="px-5 py-2 rounded-lg btn-chrome-3d-blue text-white transition-all text-sm font-bold"
          >
            Contact Us
          </a>
        </div>
      ...
      {/* Hero Section — centered glass logo */}
      <section className="relative z-10 py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          <h1
            className="text-4xl sm:text-5xl md:text-7xl font-display font-extrabold mb-4 tracking-wider leading-tight"
            style={{
          ...
          <p className="text-lg md:text-xl text-white/80 mb-8 tracking-[0.15em] uppercase font-display font-bold">
            Learning Management System
          </p>

          <p className="text-base md:text-lg text-white/60 mb-10 max-w-2xl leading-relaxed">
            Micro-lessons powered by cognitive load theory. On-device AI. 72 original textbooks. The only LMS built from the ground up for how students actually learn.
          </p>
