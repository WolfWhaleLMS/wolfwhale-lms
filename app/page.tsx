...
export default function LMSHubPage() {
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-white dark:bg-black">
      ...
      <div className="fixed top-0 -bottom-[60px] left-0 w-[80px] sm:w-[130px] md:w-[190px] lg:w-[260px] z-[5] pointer-events-none" aria-hidden="true">
        <img
          src="/pillar.jpg"
          alt=""
      ...
      <div className="fixed top-0 -bottom-[60px] right-0 w-[80px] sm:w-[130px] md:w-[190px] lg:w-[260px] z-[5] pointer-events-none" style={{ transform: 'scaleX(-1)' }} aria-hidden="true">
        <img
          src="/pillar.jpg"
          alt=""
          className="block w-full h-full object-cover object-top mix-blend-multiply dark:mix-blend-lighten dark:invert opacity-90 dark:opacity-40"
      ...
      {/* Header / Nav */}
      <header className="fixed top-0 left-0 right-0 z-50 px-3 py-3 sm:px-4 sm:py-4 backdrop-blur-xl bg-white dark:bg-black border-b border-gray-200 dark:border-white/5">
