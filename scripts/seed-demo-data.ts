/**
 * WolfWhale Learning Management System - Seed Demo Data
 *
...
async function main() {
  console.log('====================================================================')
  console.log('WolfWhale Learning Management System - Seed Demo Data')
  console.log('====================================================================')
  ...
  const announcementsList = [
    {
      ...
      content: 'Welcome back, everyone! We are excited to kick off the Spring 2026 semester at WolfWhale Learning Management System. Please review your course schedules and make sure you have all required materials. Parent-teacher conferences will be held on February 20th. Contact the office if you have any questions. Let\'s make this a great semester!',
      course_id: null,
      created_by: adminId,
    },
    {
