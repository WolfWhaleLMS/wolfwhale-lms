import { BarChart3, BookOpen, CalendarCheck, GraduationCap } from 'lucide-react'
...
export function GuardianDashboard({ view }: { view: GuardianView }) {
  return (
    <LmsShell title="Guardian dashboard" subtitle="Linked student progress, grades, upcoming work, and school alerts.">
      <section data-testid="guardian-linked-students" className="grid gap-4 lg:grid-cols-2">
