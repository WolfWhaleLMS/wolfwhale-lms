...
const curriculumData: SubjectData[] = [
  ...
  },
  {
    ...
    grades: [
      ...
      { grade: '5', textbook: 'WolfWhale ELA 5', chapters: 4, outcomes: ['CR5.1', 'CR5.2', 'CR5.3', 'CR5.4', 'CC5.1', 'CC5.2', 'CC5.3', 'CC5.4', 'AR5.1', 'AR5.2'] },
      ...
      { grade: '8', textbook: 'WolfWhale ELA 8', chapters: 4, outcomes: ['CR8.1', 'CR8.2', 'CR8.3', 'CR8.4', 'CR8.5', 'CR8.6', 'CR8.7', 'CR8.8', 'CC8.1', 'CC8.2', 'CC8.3', 'CC8.4', 'CC8.5', 'CC8.6', 'CC8.7', 'CC8.8', 'CC8.9', 'AR8.1', 'AR8.2'] },
  ...
  },
  {
    ...
    grades: [
      ...
      { grade: '9', textbook: 'WolfWhale Science 9', chapters: 4, outcomes: ['RE9.1', 'RE9.2', 'RE9.3', 'RE9.4', 'AE9.1', 'AE9.2', 'AE9.3', 'CE9.1', 'CE9.2', 'CE9.3', 'CE9.4', 'EU9.1', 'EU9.2', 'EU9.3', 'EU9.4'] },
  ...
  },
  {
    ...
    grades: [
      ...
      { grade: '4', textbook: 'WolfWhale Social Studies 4', chapters: 4, outcomes: ['IN4.1', 'IN4.2', 'IN4.3', 'DR4.1', 'DR4.2', 'DR4.3', 'PA4.1', 'PA4.2', 'PA4.3', 'PA4.4', 'RW4.1', 'RW4.2', 'RW4.3'] },
      ...
      { grade: '7', textbook: 'WolfWhale Social Studies 7', chapters: 4, outcomes: ['IN7.1', 'IN7.2', 'IN7.3', 'DR7.1', 'DR7.2', 'DR7.3', 'PA7.1', 'PA7.2', 'PA7.3', 'RW7.1', 'RW7.2', 'RW7.3'] },
  ...
  },
  {
    ...
    grades: [
      ...
      { grade: '2', textbook: 'WolfWhale Health 2', chapters: 4, outcomes: ['USC2.1', 'USC2.2', 'USC2.3', 'USC2.4', 'USC2.5', 'USC2.6', 'DM2.1', 'AP2.1'] },
      ...
      { grade: '5', textbook: 'WolfWhale Health 5', chapters: 4, outcomes: ['USC5.1', 'USC5.2', 'USC5.3', 'USC5.4', 'USC5.5', 'USC5.6', 'USC5.7', 'DM5.1', 'AP5.1'] },
      ...
      { grade: '8', textbook: 'WolfWhale Health 8', chapters: 4, outcomes: ['USC8.1', 'USC8.2', 'USC8.3', 'USC8.4', 'USC8.5', 'USC8.6', 'USC8.7', 'DM8.8', 'DM8.9', 'AP8.10'] },
